...
export default {
  ...
  setup() {
    ...
    const fetchList = async (params: ITaskSearchParams = {}) => {
      ...
      let [impList, norList] = await Promise.all([taskData.list({ important: [401, true], completed: [401, false] }), taskData.list({ important: [401, false], completed: [401, false], ...searchParams/*createTime: [414, getDateTime(dayjs().subtract(1, 'day'))]*/ })]);
